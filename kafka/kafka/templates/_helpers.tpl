...
{{/* Configuration extra bitnami */}}
{{- define "broker.customConfig" -}}
{{- if .Values.broker.customConfig }}
{{- if .Values.broker.customConfig.offsetsTopicReplicationFactor }}
offsets.topic.replication.factor={{ .Values.broker.customConfig.offsetsTopicReplicationFactor }}
{{- end -}}
{{- if and .Values.broker.customConfig.transactionStateLogReplicationFactor }}
transaction.state.log.replication.factor={{ .Values.broker.customConfig.transactionStateLogReplicationFactor }}
{{- end -}}
{{- if .Values.broker.customConfig.transactionStateLogMinIsr }}
transaction.state.log.min.isr={{ .Values.broker.customConfig.transactionStateLogMinIsr }}
{{- end -}}
{{- end -}}
